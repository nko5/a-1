...
~~~sh
# getting the code
git clone git@github.com:nko5/a-1.git && cd ./a-1/
...
# deploying to Modulus (to http://a-1.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/a-1" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
